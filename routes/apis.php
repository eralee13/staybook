...
// Route::prefix('apis/v1/')->group(function () {
    // tourmind
    ...
    Route::get('EtgGetAllBooking', [EmergingAllBookingController::class, 'getAll'])->name('getAllBookingETG');
    Route::get('EtgHotelStatic', [EmergingHotelController::class, 'fetchHotelStatic']);
