                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="footer-item">
                            <ul>
                                ...
                                <li><a href="tel:{{ $contacts->first()->phone }}">{{ $contacts->first()->phone }}</a>
                                </li>
                                <li><a href="mailto:{{ $contacts->first()->email }}">{{ $contacts->first()->email }}</a>
                                </li>
                                <li><a href="{{ $contacts->first()->instagram }}" target="_blank">Instagram</a></li>
                                <li><a href="https://wa.me/{{ $contacts->first()->whatsapp }}"
