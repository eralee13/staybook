<div class="row">
                <div class="col-lg-8 col-md-12 order-xl-1 order-lg-1 order-2">
                    ...
                    <form action="{{ route('book_verify') }}">
                        ...
                        <input type="hidden" name="sum" value="{{ number_format((($request->price * 12) / 100) + $request->price, 2, '.', '') }}">
                        <input type="hidden" name="api_name" value="tourmind">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="method-item current">
                                    <div class="name">Оплатить
                                        сейчас {{ number_format((($request->price * 12) / 100) + $request->price, 2, '.', '') }} {{ $request->currency ?? '$' }}</div>
                                </div>
                ...
                <div class="col-lg-4 col-md-12 order-xl-2 order-lg-2 order-1">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="row mt">
                            ...
                            <div class="col-md-4">
                                <div class="price">{{ number_format((($request->price * 12) / 100) + $request->price, 2, '.', '') }} {{ $request->currency ?? '$'}}</div>
                            </div>
                        </div>
                    </div>
                </div>
