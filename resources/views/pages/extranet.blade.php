                    ...
                    <div class="row">
                        <div class="col-md-6 order-xl-1 order-lg-1 order-md-1 order-2">
                            ...
                            <p>Наша цель — сделать туризм умным, прозрачным и доступным. Мы верим, что технологии должны
                                ...
                                удобную платформу, через которую вы можете управлять всем: от загрузки тарифов до отслеживания
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="why-item">
                                ...
                                <p>Техподдержка, которая действительно помогает — на русском, английском и кыргызском</p>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="who-item">
                                <div class="descr"><b>Silk Way Travel (Inbound)</b> — приём туристов в Кыргызстан и Центральную Азию</div>
                            </div>
                            <div class="who-item">
                                <div class="descr"><b>Free Way</b> — внутренний и молодежный туризм</div>
                            </div>
                            <div class="who-item">
                                <div class="descr"><b>Silk Way Logistics</b> — трансферы, деловые поездки, встречи в аэропорту</div>
                            </div>
                            <div class="who-item">
                                <div class="descr"><b>StayBook OTA</b> — технологичная B2B платформа для бронирований по всему региону</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-7">
                            ...
                            <p>Наша миссия — оцифровать туристический рынок региона и дать каждому партнёру — от маленькой юрты
