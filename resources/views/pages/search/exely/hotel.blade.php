            ...
            <div class="page hotel">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            @php
                            $af = fn($arr, $cb=null, $flag=0) => array_filter((array)$arr, $cb ?? fn($v)=> (bool)$v, $flag);
                            );
                                ...
                                $rates = collect($room['rates'] ?? [])->filter()->all();
        $amenities = collect($room['amenities'] ?? [])->filter()->all();
                                $iconMap = [
                                    'wi-fi'             => 'wifi.svg',
                                    'интернет'          => 'wifi.svg',
                            ...
                            <div class="address" style="margin-top: 20px"><img src="{{ route('index') }}/img/marker_in.svg"
