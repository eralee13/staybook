                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('search') }}" method="GET" autocomplete="off">
                            <div class="row">
                                ...
                                {{-- Гости/комнаты (оставлено текущее поведение) --}}
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <script>
                                            (function(){
                                                ...
                                                function updateGlobalSummary(){
                                                    ...
                                                    summaryBtn.textContent = `@lang('main.room'): ${roomCount}, @lang('main.adult'): ${adultsTotal}, @lang('main.child'): ${childrenTotal}`;
                        ...
                        {{-- Результаты на главной (по желанию показываем кратко) --}}
                        @isset($hotels)
                            @if($hotels->count())
