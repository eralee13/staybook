...
class HotelstarRoomStaticController extends Controller
{
    public $apiKey, $url;
   ...
   public function extractJson()
    {
        ...
        $url = 'https://dev.hotelstar.ru/dump/raw/room.tar.gz';
        ...
        $gzPath  = $tmpDir.'/room.tar.gz';
        $tarPath = $tmpDir.'/room.tar';
        $outDir  = $tmpDir.'/room';
            ...
            while (($line = fgets($handle)) !== false && $count < 10 ){
                ...
                if ($item !== null) {
                    ...
                    if ( isset($item['countryId']) ) {
                        ...
                        //             'roomstar_id' => (int)$item['countryId'],
